  ...
  return (
    <div className=" relative min-h-screen justify-center items-center overflow-hidden py-6 sm:py-12 px-5 flex flex-col bg-[#272348] bg-cover bg-center">
      ...
      <div className="h-1/2 justify-center items-center flex-col flex">
        <div className="mx-10 gap-5 flex flex-col justify-center items-center p-5 shadow-purple-900 shadow-lg  rounded-xl  bg-gradient-to-tl  from-[#B24592] to-[#F15F79]">
          <img
            src={
          ...
          />
          <div className=" gap-2 flex flex-col text-white font-semibold text-center font-mono text-xs sm:text-lg">
